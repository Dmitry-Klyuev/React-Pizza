...
export const Home = () => {
    ...
    const sortCategory = activeCategories > 0 ? activeCategories : '';
    ...
    React.useEffect(() => {
        setIsLoading(true);
        fetch(`https://6314e211fa82b738f7501ac3.mockapi.io/items?${sortBy}&category=${sortCategory}`)
            .then(res => res.json())
            .then((data) => {
                setItems(data);
                setIsLoading(false);
            });
    }, [activeSort, activeCategories]);
